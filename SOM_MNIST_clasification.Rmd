...
```{r somClusterGral, echo=TRUE, fig.align='center', warning=FALSE, fig.cap="Fig 8. Cluster con distintos metodos de alglomeracion.", fig.height=17}
# metodos disponibles
...
```{r loadFE, comment="", echo=TRUE, warning=FALSE, fig.align='center',fig.cap="Fig 15. Muestras aleatorias (50) del dataset face expression"}
...
```{r somClusterGralFE, echo=TRUE, fig.align='center', warning=FALSE, fig.cap="Fig 21. Cluster con distintos metodos de alglomeracion.", fig.height=17}
# metodos disponibles
method <- c("ward.D", "complete", "average", "mcquitty")
som_cluster <- list()
tabCl <- list()
...
```{r somPredRepFE, echo=TRUE, fig.align='center', warning=FALSE, fig.cap="Fig 24. Zonas del mapa asociadas a cada clase.", fig.height=15}
par(mfrow = c(3,5))
