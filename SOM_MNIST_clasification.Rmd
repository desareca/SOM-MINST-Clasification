...
```{r somClusterGral, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 8. Cluster con distintos metodos de alglomeracion."}
# metodos disponibles
...
```{r somCluster1, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 8. Cluster con distintos metodos de alglomeracion."}
k = 1
par(mfrow = c(1,2))
...
```{r somCluster2, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 8. Cluster con distintos metodos de alglomeracion."}
k = 2
par(mfrow = c(1,2))
# seleccion un metodo en particular
som_cluster <- cutree(hclust(dist(data.SOM$codes[[1]]), method = method[k]), k = 10)
...
```{r somCluster4, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 8. Cluster con distintos metodos de alglomeracion."}
k = 4
par(mfrow = c(1,2))
# seleccion un metodo en particular
som_cluster <- cutree(hclust(dist(data.SOM$codes[[1]]), method = method[k]), k = 10)
...
```{r somCluster5, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 8. Cluster con distintos metodos de alglomeracion."}
k = 5
par(mfrow = c(1,2))
# seleccion un metodo en particular
som_cluster <- cutree(hclust(dist(data.SOM$codes[[1]]), method = method[k]), k = 10)
...
```{r somCluster6, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 8. Cluster con distintos metodos de alglomeracion."}
k = 6
par(mfrow = c(1,2))
# seleccion un metodo en particular
som_cluster <- cutree(hclust(dist(data.SOM$codes[[1]]), method = method[k]), k = 10)
...
```{r somPredRepSd, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 11. Desviacion de representacion de clases por neurona.\n"}
...
```{r newTarget, echo=TRUE, fig.align='center', warning=FALSE, cache=FALSE, comment=""}
...
```{r somPredTablePar, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 12. Distribucion de clases por neurona."}
som.prediction <- predict(data.SOM, newdata = trainingdata$measurements)
...
```{r somPredRepPar, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 13. Zonas del mapa asociadas a cada clase."}
...
```{r somPredPSd, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment="", fig.cap="Fig 14. Desviacion de representacion de clases por neurona."}
...
```{r somTestPass, echo=TRUE, fig.align='center', warning=FALSE, cache=TRUE, comment=""}
